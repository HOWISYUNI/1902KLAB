...
/*TODO
*  1. library actvity 연결
*  2. 위아래 동작을 아이트래킹으로 연결 -> how? */
...
public class MainActivity extends AppCompatActivity
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyAhvskD9oj8bs8LUjTqfYhf855_ued8P9c";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mCameraView를 CameraBridgeViewBase로 선언해서 xml에 JavaCameraView로 선언된 카메라뷰를 캐스팅해준다.
        //mCameraView에 setAlpha 메서드를 이용해 전면카메라를 사용해도 폰 디스플레이엔 카메라 결과가 출력되지 않는다.
        mCameraView = (CameraBridgeViewBase)findViewById(R.id.CameraView);
        mCameraView.setAlpha(0);
        //mCameraView = findViewById<CameraBridgeViewBase>(R.id.CameraView);
        ...
        //텍스트 끌어오기
        bookdom = (TextView) findViewById(R.id.bookdomain);
        bookdom.setText(readTxt());

        view_height = get_height();
        view_center_x = get_center_x();
    ...
    private int get_center_x() {
        ...
        return location[0] + (bookdom.getMeasuredWidth() / 2);
    }


    private int get_height() {
        return bookdom.getMeasuredHeight();
    }
    ...
    // vision api 부르기
    // AsyncTask(faceDetectionTask) 시작( by. execute(bitmap) )
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            ...
            //AsyncTask<Object, Void, Float> faceDetectionTask = new LableDetectionTask(this, prepareAnnotationRequest(bitmap));
    ...
    private class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                returnVal = Float.parseFloat(result);
                //testview.setText("hello");
                testview.setText(Integer.toString(view_height));

                if (returnVal <= 500) {// UPPER BOUND "RED"
                    testview.setBackgroundColor(Color.parseColor("#ff0d00"));
                    bookdom.scrollTo(view_center_x,(int)returnVal-10);
                }else if(returnVal >= 600) {// LOWER BOUND "GREEN"
                    testview.setBackgroundColor(Color.parseColor("#15ff00"));
                    bookdom.scrollTo(view_center_x,(int)returnVal+10);
                }else {// DEFAULT "YELLOW"
                    testview.setBackgroundColor(Color.parseColor("#FFEA00"));
                }
